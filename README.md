...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/schwifty-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14172&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/schwifty-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `schwifty` can be installed with:

```
conda install schwifty
```

It is possible to list all of the versions of `schwifty` available on your platform with:
